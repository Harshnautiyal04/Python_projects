...
if choice1 == "left":
    choice2 = input('You\'ve come to a lake. There is a n island in the island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim accross.\n').lower()
    if choice2 == "wait":
